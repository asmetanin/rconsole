...
Demo.prototype.doInit = function() {
  ...
  this.printUnicode(
    'This script simulates a minimal BASIC interpreter for Ruby, allowing you to\r\n' +
    'experiment with the JavaScript terminal emulator.' +
    '\r\n' +
    '\r\n');
  this.gotoState(2 /* STATE_PROMPT */);
  return false;
...
Demo.prototype.doEval = function() {
    ...
    $.ajax({
        ...
        statusCode: {
            404: function () {
                alert("Command can't be executed. Error: Page Not Found!");
            }
        }
    });

    this.consoleHistory.appendLine(line);
    this.vt100(response);
